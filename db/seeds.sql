...
('Saritha', 'Patel', 12, null)
('Pete', 'Galveson', 13, null)
('Zoe', 'Jedrzejczyk', 14, null)
('Angus', 'Nogueira', 15, 7)

('Carla', 'Mariopa', 16, 8)
('Dewey', 'Snow', 17, null)
('Markham', 'St. Pierre', 18, 9)

('Dewey', 'Bigglesworth', 19, 10)
('Felicia', 'Chiang', 20, null)
('Louie', 'Zee', 21, null)

('Antonina', 'Shevchenko', 22, null)
